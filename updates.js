...
function getLootBd(what) {
	...
	if (game.global.challengeActive == "Nurture" && what == "Helium"){
		...
		currentCalc *= mult;
		textString += "<tr><td class='bdTitle'>Cruffys</td><td>Lv " + game.challenges.Nurture.getLevel() + "</td><td>" + prettify(game.talents.tier11f.effPow()*100) + "% effective</td><td>x " + prettify(mult) + "</td><td>" + prettify(currentCalc) + "</td></tr>";
	}
