...
function tooltip(what, isItIn, event, textString, attachFunction, numCheck, renameBtn, noHide, hideCancel, ignoreShift) { //Now 20% less menacing. Work in progress.
	...
	if (what == "The Spire"){	
		if (game.global.challengeActive == "Spired"){
			tooltipText = "";
			if(game.global.world <= 1)tooltipText += "<span class='planetBreakMessage'>Welcome to Spired<sup>2</sup> Challenge! In this universe, all zones are copies of the Spires! Enemies are a lot stronger in this Challenge<sip>2</sup>!<br/><br/></span>";
